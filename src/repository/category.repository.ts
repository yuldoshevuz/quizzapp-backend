...
export class CategoryRepository {
    ...
    async findById(categoryId: string, authorId: string): Promise<Category | null> {
    ...
    async updateById(categoryId: string, data: UpdateCategory, authorId: string): Promise<Category | null> {

...
export class PhotoService {
    ...
    constructor(
        ...
        this.DEFAULT_PROFILE_PHOTO = configService.get<string>('DEFAULT_PROFILE_PHOTO');
    }
    ...
    private async getUserProfilePhotos(telegramId: string): Promise<UserProfilePhotos | null> {
        try {
    ...
    private async getFirstPhotoLink(userPhotos: UserProfilePhotos): Promise<URL | null> {
        try {
